#! /bin/bash -l
# curl -s https://raw.githubusercontent.com/pedroaugustoferreira/servicegrab/master/linux/install.sh?$RANDOM | bash -s --
check()
{ 
...
start()
{
    ...
    curl -O https://raw.githubusercontent.com/pedroaugustoferreira/servicegrab/master/linux/main.sh?$RANDOM &> /dev/null
